import{_ as n,o as s,c as a,e}from"./app-52052bff.js";const i={},t=e(`<h2 id="文件管理" tabindex="-1"><a class="header-anchor" href="#文件管理" aria-hidden="true">#</a> 文件管理</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 将该目录下所有文件放入暂存区</span>
